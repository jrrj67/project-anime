!function (e, t) {
    ...
    function v(e, t, n, r, a) {
        var s = t.split(" ");
        if (M.boolean(a) || (a = !1), e instanceof NodeList) for (var o = 0; o < e.length; o++) e[o] instanceof Node && v(e[o], arguments[1], arguments[2], arguments[3]); else for (var i = 0; i < s.length; i++) e[r ? "addEventListener" : "removeEventListener"](s[i], n, a)
    }
    ...
    function _() {
        ...
        if (M.undefined(t.cancelFullScreen)) for (var r = 0, a = n.length; r < a; r++) {
    ...
    function E(v, E) {
        ...
        function V() {
            return {url: E.iconUrl, absolute: 0 === E.iconUrl.indexOf("http") || We.browser.isIE}
        }
                        ...
                        l.onreadystatechange = function () {
                            if (4 === l.readyState) if (200 === l.status) {
                                ...
                                for (var a = 0; a < t.length; a++) {
                                    e = t[a], We.captions[a] = [];
                                    var s = e.split(r), o = 0;
                                    -1 === s[o].indexOf(":") && (o = 1), We.captions[a] = [s[o], s[o + 1]]
                                }
        ...
        function W(e) {
            ...
            if (!We.usingTextTracks && "video" === We.type && We.supported.full && (We.subcount = 0, e = M.number(e) ? e : We.media.currentTime, We.captions[We.subcount])) {
                for (; n(We.captions[We.subcount][0]) < e.toFixed(1);) if (We.subcount++, We.subcount > We.captions.length - 1) {
        ...
        function $() {
            var e = U("input:not([disabled]), button:not([disabled])"), t = e[0], n = e[e.length - 1];
        ...
        function J(e, t) {
            if (M.string(t)) d(e, We.media, {src: t}); else if (t.constructor === Array) for (var n = t.length - 1; n >= 0; n--) d(e, We.media, t[n])
        }
        ...
        function z() {
            ...
            var r;
            if (M.string(E.selectors.controls.container) && (r = t.querySelector(E.selectors.controls.container)), M.htmlElement(r) || (r = We.container), r.insertAdjacentHTML("beforeend", n), E.tooltips.controls) for (var a = U([E.selectors.controls.wrapper, " ", E.selectors.labels, " .", E.classes.hidden].join("")), s = a.length - 1; s >= 0; s--) {
                var i = a[s];
        ...
        function Z(e) {
            var t = E.i18n.play;
            if (M.string(E.title) && E.title.length && (t += ", " + E.title, We.container.setAttribute("aria-label", E.title)), We.supported.full && We.buttons.play) for (var n = We.buttons.play.length - 1; n >= 0; n--) We.buttons.play[n].setAttribute("aria-label", t);
            M.htmlElement(e) && e.setAttribute("title", E.i18n.frameTitle.replace("{title}", E.title))
        }

        function ee() {
            var t = null;
            We.storage = {}, O.supported && E.storage.enabled && (e.localStorage.removeItem("plyr-volume"), (t = e.localStorage.getItem(E.storage.key)) && (/^\d+(\.\d+)?$/.test(t) ? te({volume: parseFloat(t)}) : We.storage = JSON.parse(t)))
        }
        ...
        function re() {
            var n, r = t.createElement("div"), s = We.type + "-" + Math.floor(1e4 * Math.random());
            switch (We.type) {
                case"youtube":
                    n = T(We.embedId);
                    break;
            ...
            }); else if ("vimeo" === We.type) if (We.supported.full ? We.media.appendChild(r) : r = We.media, r.setAttribute("id", s), M.object(e.Vimeo)) oe(n, r); else {
                a(E.urls.vimeo.api);
        ...
        function se(t, n) {
            We.embed = new e.YT.Player(n.id, {
                ...
                events: {
                    onError: function (e) {
                        L(We.container, "error", !0, {code: e.data, embed: e.target})
                    }, onReady: function (t) {
                        var n = t.target;
                        ...
                        L(We.container, "statechange", !1, {code: t.data})
                    }
                }
            })
        }
        ...
        function me(e) {
            var t = 0, n = We.media.paused, r = fe();
        ...
        function Te() {
            ...
            We.supported.full && (We.volume.input && (We.volume.input.value = e), We.volume.display && (We.volume.display.value = e)), te({volume: e}), m(We.container, E.classes.muted, 0 === e), We.supported.full && We.buttons.mute && k(We.buttons.mute, 0 === e)
        }

        function Se(e) {
            We.supported.full && We.buttons.captions && (M.boolean(e) || (e = -1 === We.container.className.indexOf(E.classes.captions.active)), We.captionsEnabled = e, k(We.buttons.captions, We.captionsEnabled), m(We.container, E.classes.captions.active, We.captionsEnabled), L(We.container, We.captionsEnabled ? "captionsenabled" : "captionsdisabled", !0), te({captionsEnabled: We.captionsEnabled}))
        }
        ...
        function Ee(e) {
            if (We.supported.full) {
                var t = We.progress.played, n = 0, r = fe();
                if (e) switch (e.type) {
                    case"timeupdate":
                    case"seeking":
        ...
        function Pe(e) {
            ...
            if (E.tooltips.seek && We.progress.container && 0 !== t) {
                var n = We.progress.container.getBoundingClientRect(), r = 0, a = E.classes.tooltip + "--visible";
        ...
        function Me(t) {
            if (E.hideControls && "audio" !== We.type) {
                var n = 0, r = !1, a = t, o = f(We.container, E.classes.loading);
        ...
        function Le() {
            function n() {
                var e = ce(), t = We.buttons[e ? "play" : "pause"], n = We.buttons[e ? "pause" : "play"];
            ...
            function o(e) {
                for (var t in We.buttons) {
                    var n = We.buttons[t];
                    if (M.nodeList(n)) for (var r = 0; r < n.length; r++) m(n[r], E.classes.tabFocus, n[r] === e); else m(n, E.classes.tabFocus, n === e)
                }
            }
            ...
            if (E.keyboardShorcuts.focused) {
                ...
                E.keyboardShorcuts.global && g(e, "keydown keyup", function (e) {
                    var t = a(e), n = r(), o = [48, 49, 50, 51, 52, 53, 54, 56, 57, 75, 77, 70, 67];
        ...
        var He, We = this, Ye = {};
        We.media = v;
        var Ue = v.cloneNode(!0), Be = function () {
            j("log", arguments)
        }, Xe = function () {
            j("warn", arguments)
        };
    ...
    return {
        setup: function (e, n) {
            function r(e, t) {
                f(t, P.classes.hook) || a.push({target: e, media: t})
            }

            var a = [], s = [], o = [P.selectors.html5, P.selectors.embed].join(",");
            ...
            return a.forEach(function (e) {
                ...
                if (M.object(i)) {
                    ...
                    h(i.getContainer(), "setup", !0, {plyr: i}), s.push(i)
                }
            }), s
        }, supported: F, loadSprite: C, get: A
    }
}), function () {
    function e(e, t) {
